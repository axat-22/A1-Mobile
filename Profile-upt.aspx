<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Buyer/index.Master" CodeBehind="Profile-upt.aspx.cs" EnableEventValidation="false" Inherits="A1Mobile.Buyer.Profile_upt" %>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="card card-primary">
                                        <div class="card-header">
                                            <h3 class="card-title">Buyer Profile </h3>
                                        </div>
                                        <!-- /.card-header -->
                                        <!-- form start -->
                                        <form>
                                            ...
                                            <div class="card-body">
                                                ...
                                                <%-- <div class="form-group">
                                                    ...
                                                    <asp:RequiredFieldValidator ValidationGroup="valid" ID="RequiredFieldValidator6" runat="server" ErrorMessage="Enter Your Pincode" Display="Dynamic" ForeColor="Red" ControlToValidate="txtpass"></asp:RequiredFieldValidator>
                                                </div>--%>
                                            </div>
