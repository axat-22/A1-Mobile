<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Seller/index.Master" CodeBehind="Orders.aspx.cs" Inherits="A1Mobile.Seller.Orders" %>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <ItemStyle HorizontalAlign="Left"></ItemStyle>
          ...
          <asp:TemplateField HeaderText="Buyer Name" ItemStyle-HorizontalAlign="left" HeaderStyle-HorizontalAlign="left">
    <ItemTemplate>
            <%# Eval("BuyerName")%>
    </ItemTemplate>
    <HeaderStyle HorizontalAlign="Left"></HeaderStyle>
